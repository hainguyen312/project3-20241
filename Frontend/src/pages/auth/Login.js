...
function Login() {
    ...
    useEffect(() => {
        ...
        google.accounts.id.initialize({
            client_id:
                "791967780254-9fp2msp2bdrnd7i754a9spsg6up9fjan.apps.googleusercontent.com",
    ...
    return (
        <div className="h-screen w-screen flex bg-[var(--login-right-bg)]">
            {/* left theme */}
            <div className="animate-slide-right h-full w-1/2 bg-gradient-to-r from-[--login-start-gradient] to-[--login-end-gradient] flex-auto">

            </div>
            {/* right theme */}
            <div className="animate-slide-left h-full w-1/2 flex items-center justify-center">
                {/* Box */}
                <div className="animate-slide-box w-80 h-100 rounded-lg border-2 border-[var(--login-border-color)] shadow-xl flex flex-col bg-[var(--login-form-container)]">
